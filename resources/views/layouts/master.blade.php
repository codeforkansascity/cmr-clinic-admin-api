            ...
            <div class="page-header">
                ...
                @if($__env->yieldContent('page-header-breadcrumbs'))
                    <nav class="breadcrumb-wrap mt-1" aria-label="breadcrumb">
                        <img src="{{ asset('img/icons/square.svg') }}" class="svg-icon svg-icon-square d-none d-lg-inline-block d-xl-inline-block" alt="Breadcrumb icon" role="presentation">
            ...
            <div class="alerts global mb-5">
                @if ( \Session::has('flash_error_message'))
                    <div class="alert alert-danger" role="alert">
                        <img src="{{ asset('img/icons/danger.svg') }}" class="svg-icon svg-icon-danger svg-icon-error d-none d-lg-inline-block d-xl-inline-block" alt="Alert" title="Alert" role="presentation">
                        {{ \Session::get('flash_error_message') }}
                    </div>
                @endif
                @if ( \Session::has('flash_info_message'))
                    <div class="alert alert-warning" role="alert">
                        <img src="{{ asset('img/icons/warning.svg') }}" class="svg-icon svg-icon-warning d-none d-lg-inline-block d-xl-inline-block" alt="Info" title="Info" role="presentation">
                        {{ \Session::get('flash_info_message') }}
                    </div>
                @endif
                @if ( \Session::has('flash_success_message'))
                    <div class="alert alert-success" role="alert">
                        <img src="{{ asset('img/icons/success.svg') }}" class="svg-icon svg-icon-success d-none d-lg-inline-block d-xl-inline-block" alt="Checkmark" title="Success" role="presentation">
