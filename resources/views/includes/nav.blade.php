        ...
        @if(Auth::check())
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown @php if(isset($nav_path[0]) && $nav_path[0] == 'meta') echo 'active'; @endphp">
                    <a class="nav-link dropdown-toggle text-white" href="#" id="dropdown-current-user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Welcome, {{ Auth::user()->name }}!
                    </a>
                    <div class="dropdown-menu" aria-labelledby="dropdown-current-user">
                        <a class="dropdown-item @php if(isset($nav_path[1]) && $nav_path[1] == 'change-password') echo 'active'; @endphp" href="/change-password">Change Password</a>
