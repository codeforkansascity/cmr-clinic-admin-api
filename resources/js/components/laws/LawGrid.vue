    ...
    <div>
        ...
        <div class="grid-top row mb-0 align-items-center">
            <div class="col-lg-8 mb-2">
                <form class="form-inline mb-0">
                    <a v-if="params.CanAdd" href="#" @click.default="goToNew" class="btn btn-primary mb-3 mb-sm-2 mr-3">Add Laws</a>
                    <search-form-group
                            class="mb-0"
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a href="/law/download" class="btn btn-primary mb-2 mr-2">Export to Excel</a>
                <a href="/law/print" class="btn btn-primary mb-2 mr-2">Print PDF</a>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            goToNew: function () {
                window.location.href = '/law/create';
            },
