    ...
    <div>
            ...
            <table class="table table-striped table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        <ss-grid-column-header
                            v-on:selectedSort="sortColumn"
                            v-bind:selectedKey="sortKey"
                            title="Sort by Commentable Type"
                            :params="{
                                sortField: 'commentable_type',
                                InitialSortOrder: 'asc'
                            }"
                        >
                            Commentable Type
                        ...
                        <ss-grid-column-header
                            v-on:selectedSort="sortColumn"
                            v-bind:selectedKey="sortKey"
                            title="Sort by Commentable Id"
                            :params="{
                                sortField: 'commentable_id',
                                InitialSortOrder: 'asc'
                            }"
                        >
                            Commentable Id
                ...
                <tbody>
                    ...
                    <tr v-else v-for="row in this.gridData" :key="row.id">
                        ...
                        <td data-title="Body">{{ row.body }}</td>
                        <td data-title="Commentable Type">
                            {{ row.commentable_type }}
                        </td>
                        <td data-title="Commentable Id">
                            {{ row.commentable_id }}
                        </td>
                        <td
                            data-title="Actions"
                        ...
                        >
                            <a
                                v-bind:href="'/comment/' + row.id + '/edit'"
                                v-if="params.CanEdit"
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a href="/comment/download" class="btn btn-primary mb-2 mr-2"
                    >Export to Excel</a
                >
                <a href="/comment/print" class="btn btn-primary mb-2 mr-2"
                    >Print PDF</a
                >
            </div>
            <ss-grid-pagination
