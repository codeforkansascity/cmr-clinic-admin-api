    ...
    <div>
            ...
            <table class="table table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr v-else v-for="row in this.gridData" :key="row.id">
                        ...
                        >
                            <a
                                v-bind:href="'/conviction/' + row.id + '/edit'"
                                v-if="params.CanEdit"
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a href="/conviction/download" class="btn btn-primary mb-2 mr-2"
                    >Export to Excel</a
                >
                <a href="/conviction/print" class="btn btn-primary mb-2 mr-2"
                    >Print PDF</a
                >
            </div>
            <ss-grid-pagination
