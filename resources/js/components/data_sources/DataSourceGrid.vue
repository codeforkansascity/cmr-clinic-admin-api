    ...
    <div>
            ...
            <table class="table table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr v-else v-for="row in this.gridData" :key="row.id">
                        <td data-title="Name">
                            <a
                                v-bind:href="'/data-source/' + row.id"
                        ...
                        <td data-title="Description"><dsp-textarea v-model="row.description"/> </td>
                        <td
                            data-title="Actions"
                            class="text-lg-center text-nowrap"
                        >
                            <a
                                v-bind:href="'/data-source/' + row.id + '/edit'"
                                v-if="params.CanEdit"
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a
                    href="/data-source/download"
                    class="btn btn-primary mb-2 mr-2"
                    >Export to Excel</a
                >
                <a href="/data-source/print" class="btn btn-primary mb-2 mr-2"
                    >Print PDF</a
                >
            </div>
            <ss-grid-pagination
...
export default {
    ...
    methods: {
        goToNew: function() {
            window.location.href = "/data-source/create";
        },
