...
<!--                            title="Sort by Mshp Version Id"-->
<!--                            :params="{-->
<!--                                sortField: 'mshp_version_id',-->
...
<!--                        </ss-grid-column-header>-->
                        ...
                        <ss-grid-column-header
                            v-on:selectedSort="sortColumn"
                            v-bind:selectedKey="sortKey"
                            title="Sort by Type Class"
                            :params="{
                                sortField: 'type_class',
                                InitialSortOrder: 'asc'
                            }"
                        >
                            Type Class
...
<!--                        <td data-title="Mshp Version Id">-->
<!--                            {{ row.mshp_version_id }}-->
<!--                        </td>-->
                        <td data-title="Charge Code" style="width: 25%">
                            <a class="no-more-tables-name-link"
                               v-bind:href="'/import-mshp-charge-code-manual/' + row.id"
...
<!--                            <a-->
<!--                                v-bind:href="-->
<!--                                    '/import-mshp-charge-code-manual/' +-->
<!--                                        row.id +-->
<!--                                        '/edit'-->
<!--                                "-->
<!--                                v-if="params.CanEdit"-->
...
<!--                <a-->
<!--                    href="/import-mshp-charge-code-manual/download"-->
<!--                    class="btn btn-primary mb-2 mr-2"-->
<!--                    >Export to Excel</a-->
<!--                >-->
<!--                <a-->
<!--                    href="/import-mshp-charge-code-manual/print"-->
<!--                    class="btn btn-primary mb-2 mr-2"-->
<!--                    >Print PDF</a-->
<!--                >-->
            </div>
...
export default {
    name: "import-mshp-charge-code-manual-grid",
    components: {
        SsGridColumnHeader,
    ...
    methods: {
        goToNew: function() {
            window.location.href = "/import-mshp-charge-code-manual/create";
        },
        ...
        getDataUrl: function(new_page_number) {
            var url = "api-import-mshp-charge-code-manual?";
            var queryParams = [];
