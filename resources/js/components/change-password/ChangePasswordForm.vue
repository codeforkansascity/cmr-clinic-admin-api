<template>
    <form @submit.prevent="handleSubmit" class="form-horizontal">
        ...
        <div class="row">
            <div class="col-md-9">
                <std-form-group label="Current Password" :errors="form_errors.current_password">
        ...
        <div class="row">
            <div class="col-md-9">
                <std-form-group label="New Password" :errors="form_errors.password">
                    <vue-password
        ...
        <div class="row">
            <div class="col-md-9">
                <std-form-group label="Confirm New Password" :errors="form_errors.confirm_password">
                    <input type="password" class="form-control"
