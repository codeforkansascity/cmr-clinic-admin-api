    ...
    <div>
            ...
            <table class="table table-striped table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        <ss-grid-column-header
                            v-on:selectedSort="sortColumn"
                            v-bind:selectedKey="sortKey"
                            title="Sort by Petition Number"
                            :params="{
                                sortField: 'petition_number',
                                InitialSortOrder: 'asc'
                            }"
                        >
                            Petition Number
                ...
                <tbody>
                    ...
                    <tr v-else v-for="row in this.gridData" :key="row.id">
                        <td data-title="Applicant Id">
                            {{ row.applicant_id }}
                        </td>
                        <td data-title="Petition Number">
                            {{ row.petition_number }}
                        </td>
        ...
        <div class="grid-bottom row mb-0 align-items-center">
            <div class="col-lg-4 mb-2">
                <a
                    href="/petition-field/download"
                    class="btn btn-primary mb-2 mr-2"
                    >Export to Excel</a
                >
                <a
                    href="/petition-field/print"
                    class="btn btn-primary mb-2 mr-2"
                    >Print PDF</a
                >
            </div>
...
export default {
    ...
    methods: {
        goToNew: function() {
            window.location.href = "/petition-field/create";
        },
