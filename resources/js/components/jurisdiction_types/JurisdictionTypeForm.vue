        ...
        <div class="row">
            <div class="col-md-12">
                <std-form-group
                        ...
                        label-for="display_sequence"
                        :errors="form_errors.display_sequence"
                >
                    <fld-input
                            name="display_sequence"
                            v-model="form_data.display_sequence"
                    />
                </std-form-group>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    >
                        ...
                        >Change Jurisdiction Type</span
                        >
                        <span v-else="this.form_data.id"
                        >Add Jurisdiction Type</span
                        >
                    </button>
                </div>
